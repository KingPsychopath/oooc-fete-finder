...
try {
  ...
  console.log('• Ready to paste directly into .env.local or Vercel environment variables');
  console.log(`• File contains ${Object.keys(parsed).length} keys including project_id: ${parsed.project_id || 'unknown'}`);
