...
export const generateOGImageUrl = (params: OGImageParams = {}): string => {
  ...
  if (params.eventCount) searchParams.set('eventCount', params.eventCount.toString());
  if (params.arrondissement) searchParams.set('arrondissement', params.arrondissement);
 ...
 */
export const generateAdminOGImage = (params: {
  title?: string;
  subtitle?: string;
} = {}): string => {
  return generateOGImageUrl({
