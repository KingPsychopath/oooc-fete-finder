		...
		() => [
			{
				...
				body: "Choose the date, stop count, vibe, start time, travel range and budget. Any unset preference stays flexible.",
				preferredSide: "right",
			},
			{
				id: "suggestions",
				selector: "#plans-route-suggestions",
				title: "Pick a suggested route",
				body: "Tap a suggestion to save it. Rebuilding an existing route replaces its stops; creating a different route keeps the old one.",
				preferredSide: "left",
			},
			{
				id: "line",
				...
				body: "Move stops up or down, pin a stop into future rebuilds, remove what does not fit, or open event details without leaving the planner.",
				preferredSide: "right",
			},
			{
				id: "saved",
				...
				body: "Events you saved for this date can be added straight into the route you are editing.",
				preferredSide: "left",
			},
			{
				id: "routes",
				...
				body: "Open a route to edit it, create a different route when you want a separate plan, or delete routes you no longer need.",
				preferredSide: "right",
			},
		],
		[],
