 ...
 * 
 * @param threshold - Percentage of page scrolled (0-100)
 * @param mode - "show-after" (default) shows element after threshold, "hide-after" hides element after threshold
 * @param initiallyVisible - Initial visibility state
 * @returns Object with isVisible boolean and current scrollPercentage
 */
