...
const EventTypeSection = memo<EventTypeSectionProps>(
	({ selectedEventTypes, onEventTypeToggle, compact = false }) => {
		if (compact) {
			return (
				<div className="flex flex-wrap gap-2">
...
const VenueTypeSection = memo<VenueTypeSectionProps>(
	({ selectedIndoorPreference, onIndoorPreferenceChange, compact = false }) => {
		if (compact) {
			return (
				<div className="flex flex-wrap gap-2">
					<Toggle
...
const PriceRangeSection = memo<PriceRangeSectionProps>(
	({ selectedPriceRange, onPriceRangeChange, compact = false }) => {
...
const GenresSection = memo<GenresSectionProps>(
	({ selectedGenres, onGenreToggle, compact = false }) => {
