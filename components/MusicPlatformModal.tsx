...
const MusicPlatformModal: React.FC<MusicPlatformModalProps> = ({
	...
	const handlePlatformSelect = (platform: "spotify" | "apple") => {
		const links = {
			spotify: "https://open.spotify.com/playlist/0zfRemqFPipkrXo5VEcATh?si=_1Kvv_wvQ6eVlF-7eNJxSA&pi=Uw3u5NKeRDqXL",
			apple: "https://music.apple.com/gb/playlist/konzombazouklove/pl.u-2aoqXWaHq8NvKE"
		};
		...
		<Dialog open={isOpen} onOpenChange={onClose}>
			<DialogContent className="sm:max-w-md">
				<DialogHeader>
					...
					<DialogDescription>
						Listen to the official FDLM🇫🇷🎉 / Konzombazouklove playlist to get in the mood for Paris!
					</DialogDescription>
				</DialogHeader>
				...
				<div className="mt-4 p-3 bg-muted rounded-lg">
					<p className="text-xs text-muted-foreground text-center">
						🎵 The perfect soundtrack for your Paris adventure - featuring Kompa, Zouk & French vibes!
					</p>
				</div>
			</DialogContent>
		</Dialog>
