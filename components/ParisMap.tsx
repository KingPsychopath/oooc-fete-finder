...
const ARRONDISSEMENT_POSITIONS = {
  1: { x: 250, y: 200, width: 40, height: 30 },
  2: { x: 260, y: 170, width: 40, height: 30 },
  3: { x: 290, y: 180, width: 40, height: 35 },
  4: { x: 280, y: 210, width: 40, height: 30 },
  5: { x: 260, y: 240, width: 45, height: 35 },
  6: { x: 220, y: 240, width: 40, height: 35 },
  7: { x: 180, y: 210, width: 50, height: 40 },
  8: { x: 220, y: 150, width: 50, height: 40 },
  9: { x: 250, y: 130, width: 40, height: 35 },
  10: { x: 290, y: 140, width: 45, height: 35 },
  11: { x: 320, y: 180, width: 50, height: 40 },
  12: { x: 330, y: 220, width: 50, height: 45 },
  13: { x: 270, y: 280, width: 55, height: 45 },
  14: { x: 200, y: 280, width: 50, height: 40 },
  15: { x: 150, y: 250, width: 60, height: 50 },
  16: { x: 120, y: 180, width: 60, height: 70 },
  17: { x: 180, y: 120, width: 55, height: 45 },
  18: { x: 240, y: 100, width: 60, height: 45 },
  19: { x: 320, y: 110, width: 50, height: 40 },
  20: { x: 350, y: 150, width: 45, height: 50 },
};
      ...
      <TooltipProvider>
        ...
        >
          ...
          {Object.entries(ARRONDISSEMENT_POSITIONS).map(([arr, pos]) => {
            ...
            return (
              <Tooltip key={arrondissement}>
                ...
                <TooltipContent>
                  <div className="p-2">
                    <p className="font-semibold">{arrondissement}e Arrondissement</p>
          ...
          <g transform="translate(20, 320)" aria-label="Map legend">
            ...
            <text x="18" y="10" className="text-xs fill-gray-700 dark:fill-gray-300">1 event</text>

            <rect x="0" y="20" width="12" height="12" fill="#f59e0b" rx="2" />
            <text x="18" y="30" className="text-xs fill-gray-700 dark:fill-gray-300">2 events</text>

            <rect x="0" y="40" width="12" height="12" fill="#ef4444" rx="2" />
            <text x="18" y="50" className="text-xs fill-gray-700 dark:fill-gray-300">3+ events</text>
          </g>
        </svg>
