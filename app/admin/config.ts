		...
		sections: [
			{
				...
				label: "User Search",
				description:
					"Find, segment, select, import, export, and act on known users.",
	...
	},
	{
		...
		sections: [
			...
			},
			{
				...
				description: "Event opens, ticket intent, and event-level action data.",
				path: "/admin/insights#insights-events",
				moduleKey: "insights",
				keywords: ["analytics", "engagement", "events", "roi"],
			},
			{
				id: "insights-discovery",
				label: "Discovery Analytics",
				description:
					"Searches, filters, map use, sort changes, and tour usage.",
				path: "/admin/insights#insights-discovery",
				moduleKey: "insights",
				keywords: ["analytics", "discovery", "search", "filters", "map"],
			},
			{
				id: "insights-exchange",
				label: "Exchange Analytics",
				description:
					"Ticket exchange visitors, listings, unlocks, and reports.",
				path: "/admin/insights#insights-exchange",
				moduleKey: "insights",
				keywords: ["analytics", "tickets", "exchange", "reports", "listings"],
			},
			{
				id: "insights-traffic",
				label: "Traffic Analytics",
				description:
					"Visitors, sources, campaigns, landing pages, and diagnostics.",
				path: "/admin/insights#insights-traffic",
				moduleKey: "insights",
				keywords: ["analytics", "traffic", "utm", "campaign", "landing"],
			},
			{
				id: "insights-planning",
				label: "Planning Analytics",
				description:
					"Route planning, sharing, exports, and shared-plan intent.",
				path: "/admin/insights#insights-planning",
				moduleKey: "insights",
				keywords: ["analytics", "planning", "routes", "shares", "exports"],
			},
		],
	},
];
